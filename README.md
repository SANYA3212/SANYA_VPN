...
3.  **Automatic Installation:** On the first run, the application will check if OpenVPN is installed. If not, it will ask for permission to download and install it into a local `vpn_engine` folder. This is a one-time setup.
